...
# Press the PS4 controller button with id 4 to immediately exit the
# visualization window. This provides a quick way to leave the dynamic
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                # Exit immediately if button id 4 is pressed
                if event.button == 4:
                    running = False
                    continue
